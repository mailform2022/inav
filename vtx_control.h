...
#define MAX_CUSTOM_BANDS 2
#define MAX_CHANNELS_PER_BAND 8
...
typedef struct {
    ...
    } bands[MAX_CUSTOM_BANDS];
    uint8_t powerCount;
    uint16_t powerlevels[8];
} customVtxTable_t;

extern customVtxTable_t customVtxTable;
extern bool customVtxTableLoaded;
